...
function SelectFrameBComp() {
    ...
    async function myfieldupdate() {
        let item = { myfield };
        try {
            let response = await fetch(`http://localhost:8000/api/edittag/5/${user.id}`, {
                method: "POST",
    ...
    return (
        <form>
            <div className="mb-3">
                <label htmlFor="exampleSelect" className="form-label m-0 p-0" style={{ float: "left" }}>Second Framework</label>
                <br />
...
export default SelectFrameBComp;
