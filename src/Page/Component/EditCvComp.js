...
function EditCvComp(){
  ...
  async function upload(){
    ...
    let result = await fetch("http://localhost:8000/api/uploadcv/"+user.id,{
      method: 'POST' ,
      body: formData
    });
            ...
            Edit Cv
              ...
              <div className="card">
                <div className="card-body">
                  <form>
                    <div className="mb-3">
                      <label for="profile_img" className="form-label mr-3" style={{float: "left"}}>Edit Cv</label>
