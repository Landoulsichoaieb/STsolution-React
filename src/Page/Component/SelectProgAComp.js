...
function SelectProgAComp() {
    ...
    async function myfieldupdate() {
        let item = { myfield };
        try {
            let response = await fetch(`http://localhost:8000/api/edittag/2/${user.id}`, {
                method: "POST",
    ...
    return (
        <form>
            <div className="mb-3">
                <label htmlFor="exampleSelect" className="form-label m-0 p-0" style={{ float: "left" }}>Programming Language</label>
                <br />
...
export default SelectProgAComp;
